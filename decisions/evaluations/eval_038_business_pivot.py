"""
TimeVault Decision Evaluation Matrix — Protocol #038
Domain: business_pivot
High-Fidelity Multi-Criteria Sensitivity Matrix and Utility Optimization.
"""
from typing import Dict, List, Any, Tuple
import math

class EvaluationMatrix_038:
    MATRIX_ID: int = 38
    DOMAIN: str = "business_pivot"
    ...
    def compute_sensitivity_tipping_point_01(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #01 for sensitivity in business_pivot.
    ...
    def compute_sensitivity_tipping_point_02(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #02 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_03(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #03 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_04(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #04 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_05(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #05 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_06(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #06 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_07(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #07 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_08(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #08 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_09(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #09 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_10(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #10 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_11(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #11 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_12(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #12 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_13(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #13 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_14(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #14 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_15(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #15 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_16(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #16 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_17(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #17 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_18(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #18 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_19(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #19 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_20(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #20 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_21(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #21 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_22(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #22 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_23(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #23 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_24(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #24 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def compute_sensitivity_tipping_point_25(self, factor_weights: Dict[str, float], candidate_ratings: List[float]) -> Dict[str, Any]:
        """
        Calculates tipping point #25 for sensitivity in business_pivot.
        Determines minimal weight perturbation required to invert option ranking.
        """
        if not factor_weights or not candidate_ratings:
            return {"tipping_delta": 0.0, "is_critical": False, "elasticity": 0.0}
    ...
    def get_benchmark_matrix_records(cls) -> List[Dict[str, Any]]:
        records = []
        records.append({
            "matrix_case": "CASE-EVAL-038-0001",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0002",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0003",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0004",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0005",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0006",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0007",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0008",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0009",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0010",
            "category": "business_pivot",
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0011",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0012",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0013",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0014",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0015",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0016",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0017",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0018",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0019",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0020",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0021",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0022",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0023",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0024",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0025",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0026",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0027",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0028",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0029",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0030",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0031",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0032",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0033",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0034",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0035",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0036",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0037",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0038",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0039",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0040",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0041",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0042",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0043",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0044",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0045",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0046",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0047",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0048",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0049",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0050",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0051",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0052",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0053",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0054",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0055",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0056",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0057",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0058",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0059",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0060",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0061",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0062",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0063",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0064",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0065",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0066",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0067",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0068",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0069",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0070",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0071",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0072",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0073",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0074",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0075",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0076",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0077",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0078",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0079",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0080",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0081",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0082",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0083",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0084",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0085",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0086",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0087",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0088",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0089",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0090",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0091",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0092",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0093",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0094",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0095",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0096",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0097",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0098",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0099",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0100",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0101",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0102",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0103",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0104",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0105",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0106",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0107",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0108",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0109",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0110",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0111",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0112",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0113",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0114",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0115",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0116",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0117",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0118",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0119",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0120",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0121",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0122",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0123",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0124",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0125",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0126",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0127",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0128",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0129",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0130",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0131",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0132",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0133",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0134",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0135",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0136",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0137",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0138",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0139",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0140",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0141",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0142",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0143",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0144",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0145",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0146",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0147",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0148",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0149",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0150",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0151",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0152",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0153",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0154",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0155",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0156",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0157",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0158",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0159",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0160",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0161",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0162",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0163",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0164",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0165",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0166",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0167",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0168",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0169",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0170",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0171",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0172",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0173",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0174",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0175",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0176",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0177",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0178",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0179",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0180",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0181",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0182",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0183",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0184",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0185",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0186",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0187",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0188",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0189",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0190",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0191",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0192",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0193",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0194",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0195",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0196",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0197",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0198",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0199",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0200",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0201",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0202",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0203",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0204",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0205",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0206",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0207",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0208",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0209",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0210",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0211",
            "category": "business_pivot",
            "weight_sensitivity": 0.2,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0212",
            "category": "business_pivot",
            "weight_sensitivity": 0.3,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0213",
            "category": "business_pivot",
            "weight_sensitivity": 0.4,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0214",
            "category": "business_pivot",
            "weight_sensitivity": 0.5,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0215",
            "category": "business_pivot",
            "weight_sensitivity": 0.6,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0216",
            "category": "business_pivot",
            "weight_sensitivity": 0.7,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0217",
            "category": "business_pivot",
            "weight_sensitivity": 0.8,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0218",
            "category": "business_pivot",
            "weight_sensitivity": 0.9,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0219",
            "category": "business_pivot",
            "weight_sensitivity": 1.0,
        ...
        records.append({
            "matrix_case": "CASE-EVAL-038-0220",
            "category": "business_pivot",
            "weight_sensitivity": 0.1,
